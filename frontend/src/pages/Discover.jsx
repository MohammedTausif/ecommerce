...
const Discover = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row mt-8  space-x-4 ">
      ...
      {/* Right Side - Content */}
      <div className="w-full md:w-1/2 flex items-center relative  md:bottom-20  justify-center  md:p-6 p-3   ">
        <div className="text-center">
          <h1 className="text-4xl md:text-[48px] font-Playfair md:mb-4 mb-2">The ROGER Tracksuit</h1>
